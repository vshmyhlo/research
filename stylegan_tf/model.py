...
def conv2d_layer(x, fmaps, kernel, up=False, down=False, resample_kernel=None, gain=1, use_wscale=True, lrmul=1,
                 weight_var='weight'):
...
def G_main(
    ...
    dlatents = components.mapping.get_output_for(latents_in, is_training=is_training, **kwargs)
    ...
    if style_mixing_prob is not None:
        with tf.variable_scope('StyleMix'):
            ...
            dlatents2 = components.mapping.get_output_for(latents2, is_training=is_training, **kwargs)
