...
from eff_det.anchor_utils import compute_anchor
from eff_det.box_coding import decode_boxes, shifts_scales_to_boxes, boxes_to_shifts_scales
from eff_det.box_utils import boxes_iou
from eff_det.config import build_default_config
from eff_det.datasets.coco import Dataset as CocoDataset
from eff_det.datasets.wider import Dataset as WiderDataset
from eff_det.losses import boxes_iou_loss, smooth_l1_loss, focal_loss
from eff_det.map import per_class_precision_recall_to_map
from eff_det.metrics import FPS, PerClassPR
from eff_det.model import RetinaNet
from eff_det.transform import Resize, BuildLabels, RandomCrop, RandomFlipLeftRight, denormalize, FilterBoxes
from eff_det.utils import draw_boxes, pr_curve_plot, fill_scores
...
def main():
    ...
    train_dataset = Dataset(args.dataset_path, subset='eval', transform=train_transform)
